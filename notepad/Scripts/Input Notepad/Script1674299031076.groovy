...
Windows.setText(findWindowsObject('Object Repository/Document'), 'My Firs Test Dekstop Application')

Windows.setText(findWindowsObject('Object Repository/Window'), 'Is dificult to test dekstop App')
